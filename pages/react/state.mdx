...
<Callout>
  👨🏼‍💻 Don't be afraid to hardcode things to test. It also can be useful for your
  product! Almost all to-do apps have some default items when you first open the
  app that acts as a tutorial. What you just build mimics that and is useful for
  your product!
</Callout>
...
<Callout>
  🐢 React will not re-render the component immediately. When you change state
  then React will re-render the component at its next earliest convenience.
</Callout>
