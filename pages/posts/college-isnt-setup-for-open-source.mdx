...
export const meta = {
  ...
  excerpt: '',
  createdAt: '2017-02-02T08:00:00.000Z',
}
...
complete them _alone_, without any assistance, to learn the concepts.
...
1.  Have everyone in the fall semester do project 1, and have everyone
    in the sprint semester _fork_ one of those projects, (their choice)
