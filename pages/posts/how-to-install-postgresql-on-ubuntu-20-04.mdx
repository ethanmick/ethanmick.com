...
export const meta = {
  type: 'POST',
  title: 'How to install PostgreSQL 14 on Ubuntu 20.04',
  author: 'Ethan Mick',
  slug: 'how-to-install-postgresql-on-ubuntu-20-04',
  excerpt: 'Learn how to set up PostgreSQL on Ubuntu 20.04.',
