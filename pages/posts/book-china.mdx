...
This book, was _amazing_. I wanted to understand China _now_, not the
...
_and there are pros and cons to both_.
...
did twenty years ago, that this government has been _good_ for them. Of
...
things are _so_ much better that they are willing to pay a price for
that.
...
them all. Censorship and control is _much_ harder with the Internet. The
