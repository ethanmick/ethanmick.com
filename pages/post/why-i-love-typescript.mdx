...
export const meta = {
  ...
  excerpt: 'TypeScript adds incredibly useful features to JavaScript with a powerful compiler, interfaces, enums, decorators, and more. With great community support and fantastic releases, TypeScript should be your go to for writing complex JavaScript.',
...
started coded Node in.

And you know? I didn't hate it. When I had to write some *regular*
...
![CoffeeScript Code
Frequency](/public/images/coffeescript-code-frequency.png)
...
CoffeeScript was supposed to compile down to ES3, something *every*
...
*documentation* for how to use Angular in JavaScript. It felt like
TypeScript or bust. And hey, I'm not stranger to *languages that look
like JavaScript*, so sign me up.
