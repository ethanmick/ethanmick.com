...
export const meta = {
  ...
  excerpt: 'There are times when sharing a GIF is easier, more convenient, and faster than sharing a video file. FFmpeg is the perfect tool to quickly convert the video into a quality GIF.',
